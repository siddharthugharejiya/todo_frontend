          ...
          <ul className="todo-list">
            {todo.map((el) => (
              <li
                id={el._id}
                key={el._id}
                className={`todo ${check === el._id ? "completed" : ""}`}
              >
                ...
                <input
                  type="checkbox"
                  onChange={() => handleclick(el._id)}
                />


                <div className="d-flex">
                  <button className="button m-1" onClick={() => del(el._id)}>
                    <svg
                  ...
                  <button className="editBtn m-1" onClick={() => edite(el._id, el.task)}>
